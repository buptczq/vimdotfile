...
" Vim UI {
    ...
    if !exists('g:override_spf13_bundles') && filereadable(expand("$VIMBUNDLE_ROOT/vim-colors-solarized/colors/solarized.vim"))
...
" Plugins {
    ...
    " Ctags {
        set tags=./tags;/,$VIMRC_ROOT/.vimtags
    ...
    " PyMode {
        ...
        if isdirectory(expand("$VIMBUNDLE_ROOT/python-mode"))
    ...
    " ctrlp {
        if isdirectory(expand("$VIMBUNDLE_ROOT/ctrlp.vim/"))
            ...
            if isdirectory(expand("$VIMBUNDLE_ROOT/ctrlp-funky/"))
                " CtrlP extensions
    ...
    " YouCompleteMe {
        if count(g:spf13_bundle_groups, 'youcompleteme')
            ...
            " $VIMRC_ROOT/.cabal/bin is in your $PATH.
